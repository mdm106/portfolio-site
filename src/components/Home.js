        ...
        <Media queries={{ mobile: { maxWidth: 699 } }}>
            ...
            <div className="container page-content">
                ...
                <section className="main-text">
                    ...
                    <p>My commercial experience has primarily been in Ruby on Rails applications. I also have used Vue.js, jQuery and Angular in a commercial setting. Prior to my first commercial role, I completed a 12 week bootcamp with DevelopMe where I learnt Laravel and React.
                    </p>
